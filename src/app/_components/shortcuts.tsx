...
export default function ShortCuts({
  ...
  return (
    <div className="flex flex-row overflow-x-auto border-b-1 border-teal-900 p-4 whitespace-nowrap">
        ...
        <Tooltip key={crypto.randomUUID()} disableHoverableContent={true}>
          <TooltipTrigger asChild>
            <button
              ...
              onClick={() =>
                handleShortCutClick(shortcut.action, shortcut.fn === "write")
              }
              onMouseDown={(e) => e.preventDefault()}
            >
              <img alt="error" className="invert filter" src={shortcut.svg} />
            </button>
          </TooltipTrigger>
          <TooltipContent>
            <p>{shortcut.action}</p>
